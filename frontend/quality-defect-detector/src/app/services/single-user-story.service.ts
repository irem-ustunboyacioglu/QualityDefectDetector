...
export class SingleUserStoryService {
  ...
  public suggestionForSpelling(userStory: string): Observable<Array<Array<string>>> {
    return this.httpClient.get<Array<Array<string>>>(`${this.apiURL}/user-story-defects/check-spelling`,
      {params: {sentence: userStory}});
  }
}
