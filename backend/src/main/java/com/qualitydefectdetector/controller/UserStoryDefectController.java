...
public class UserStoryDefectController {
    ...
    @GetMapping("/conflict-free")
    public CriteriaCheckResult checkProblemOrientedCriteria(@RequestParam List<String> sentences) {
    ...
    public SetOfUserStoryReport analyseMultipleUserStory(@RequestParam("sentences") List<String> sentences) {
